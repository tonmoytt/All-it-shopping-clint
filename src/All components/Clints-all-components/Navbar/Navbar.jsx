    ...
    return (
        <div className="bg-black text-white text-sm px-20 py-2 flex justify-between items-center">
            ...
            <div className="relative">
                <div className="bg-yellow-400 text-black px-5 py-[10px] flex items-center gap-2 font-semibold rounded-sm w-64">
                    <FaBars className="text-lg" />
                    <span className="uppercase text-lg tracking-wide">All Categories</span>
                </div>

                {/* Always Visible Menu */}
                <div className="absolute top-[100%] left-0 w-64 bg-white text-black shadow-xl py-3 mt-1 z-50">
                    <ul className="space-y-3 px-5 text-[18px] font-sans leading-5">
                        <li className="flex justify-between items-center border-b border-gray-300 pb-3 text-gray-700">
                        ...
                        <li className="border-b border-gray-300 pb-3 text-gray-700">Blogs</li>
                        <li className="flex justify-between items-center border-b border-gray-300 pb-3 text-gray-700">
                        ...
                        <li className="border-b border-gray-300 pb-3 text-gray-700">Collection</li>
                        <li className="border-b border-gray-300 pb-3 text-gray-700">Contact</li>
                        <li className="border-b border-gray-300 pb-3 text-gray-700">Included Pages</li>
                        <li className="border-b border-gray-300 pb-3 text-gray-700">Aboutus</li>
