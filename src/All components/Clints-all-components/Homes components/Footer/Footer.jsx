  ...
  return (
    <footer className="footer-wrapper text-white text-sm relative">
      ...
      <div className="max-w-6xl mx-auto px-4 py-14 grid md:grid-cols-4 gap-10 border-b border-white/20">
        ...
        <div className="fade-in-up">
          ...
          <p className="text-[11px] text-gray-300 mt-3">
            This site is intended for US consumers. By signing up, you agree to our{' '}
      ...
      <div className="text-[11px] text-center text-gray-400 px-4 pb-4">
        This site is intended for US consumers. Cookies and related technology are used for advertising. To learn more, visit{' '}
        <span className="underline cursor-pointer">AdChoices</span> and our{' '}
